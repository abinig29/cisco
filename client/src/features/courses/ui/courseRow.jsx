...
import { selectAllCourses, selectCoursebyId, useDeleteCourseMutation } from '../courseApiSillce'
...
const CourseRow = ({ courseId }) => {
    ...
    const [deleteCourse, { isError, error, isSuccess, isLoading }] = useDeleteCourseMutation()
    ...
    const sourses = useSelector(selectAllCourses)


    return (
        course && <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
