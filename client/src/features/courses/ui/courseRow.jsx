...
import { useDeleteCourseMutation } from "../courseApiSillce";
...
const CourseRow = ({ course }) => {
  ...
  const [deleteCourse, { isError, error, isSuccess, isLoading }] =
  ...
  return (
    <tr className="bg-white border-b dark:bg-gray-800 dark:border-gray-700 hover:bg-gray-50 dark:hover:bg-gray-600">
      ...
      <td class="px-6 py-4">{course.endDate.split("T")[0]}</td>
      <td class="px-6 py-4">
        {
          course.courseProvider.catagoryName
        }
      </td>
      <td className="px-6 py-4">
        <div className="inline-flex gap-2">
          <button
            onClick={() => navigate(`/dash/courses/${course._id}`)}
